...
@foreach ($page8Findings ?? [] as $finding)
    @php
            ...
            <tbody>
                @foreach ($finding['cofRows'] ?? [] as $row)
                    <tr>
                        ...
                        <td class="center">{{ $row['opening_balance'] ?? '' }}</td>
                        <td class="center">{{ $row['closing_balance'] ?? '' }}</td>
                        <td class="center">{{ $row['total_balance'] ?? '' }}</td>
                        <td class="center">{{ $row['avg_balance'] ?? '' }}</td>
                        <td class="center">{{ $row['profit_rate_10'] ?? '' }}</td>
                        <td class="center">{{ $row['monthly_profit'] ?? '' }}</td>
                        <td class="center">{{ $row['branch_charged'] ?? '' }}</td>
                        <td class="center">{{ $row['variance'] ?? '' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
