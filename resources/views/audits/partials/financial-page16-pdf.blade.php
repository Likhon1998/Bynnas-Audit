...
@foreach ($page16Findings ?? [] as $finding)
    @php
    ...
    @if (($finding['criteria'] ?? '') !== '')
        <p class="justify" style="margin:0;white-space:pre-wrap;">{{ $finding['criteria'] }}</p>
    @else
            ...
            <tbody>
                @foreach ($finding['passbookAbsentRows'] ?? [] as $row)
                    <tr>
                        ...
                        <td class="center">{{ $row['total_members'] ?? '' }}</td>
                        <td class="center">{{ $row['passbooks_received'] ?? '' }}</td>
                        <td class="center">{{ $row['passbooks_absent'] ?? '' }}</td>
                        <td>{{ $row['officer_comment'] ?? '' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
