...
@foreach ($page15Findings ?? [] as $finding)
    @php
            ...
            <tbody>
                @foreach ($finding['arrearsRows'] ?? [] as $row)
                    <tr>
                        ...
                        <td class="center">{{ $row['loan_amount'] ?? '' }}</td>
                        <td class="center">{{ $row['actual_due_date'] ?? '' }}</td>
                        <td class="center">{{ $row['software_due_date'] ?? '' }}</td>
                        <td class="center">{{ $row['installment_date'] ?? '' }}</td>
                        <td class="center">{{ $row['actual_arrears'] ?? '' }}</td>
                        <td class="center">{{ $row['software_arrears'] ?? '' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
