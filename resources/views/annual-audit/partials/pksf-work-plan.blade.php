    ...
    <div class="flex flex-wrap items-center gap-x-3 gap-y-1.5 border-b border-slate-200 bg-slate-50/80 px-3 py-1.5">
        ...
        @can('projects.manage')
            <a
                ...
                class="inline-flex h-7 items-center gap-1 rounded-md border border-slate-200 bg-white px-2 text-[12px] font-medium text-slate-700 hover:bg-slate-50"
            >
                + Add via Projects
            </a>
        @endcan
    ...
    <div class="max-h-[calc(100vh-13rem)] overflow-auto">
        <table class="min-w-full border-collapse text-left">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="16" class="border border-slate-300 px-3 py-6 text-center text-[12px] text-slate-500">
            ...
            @if ($rows->isNotEmpty())
                <tfoot>
                    <tr class="bg-orange-50 text-[12px] font-semibold text-navy-900">
