    ...
    <div class="max-h-[calc(100vh-13rem)] overflow-auto">
        <table class="min-w-full border-collapse text-left">
            <thead class="sticky top-0 z-20">
                <tr class="bg-sky-100 text-xs font-semibold tracking-wide text-navy-900">
                ...
                <tr class="bg-slate-100 text-xs font-semibold tracking-wide text-slate-600">
                    @foreach ($months as $monthIndex => $month)
                        ...
                        <th class="border border-slate-300 px-0.5 py-1 text-center min-w-[48px] {{ $qBg }}">
                            <div class="text-[13px] font-bold leading-none text-navy-900">{{ $monthTotals[$monthIndex] }}</div>
