        ...
        <div class="grid min-h-0 flex-1 grid-cols-1 divide-y divide-slate-200 lg:grid-cols-2 lg:divide-x lg:divide-y-0">
            <div class="min-h-0 overflow-y-auto p-3">
                ...
                <div class="mb-3 flex flex-wrap gap-2">
                    <button type="button" wire:click="applyCustomTableTemplate({{ $blockIndex }}, 'expense')" class="rounded border border-amber-400 bg-amber-50 px-2 py-1 text-[10px] font-semibold text-amber-950 hover:bg-amber-100">নমুনা Expense টেমপ্লেট লোড</button>
                    <button type="button" wire:click="applyCustomTableTemplate({{ $blockIndex }}, 'blank')" class="rounded border border-slate-300 bg-white px-2 py-1 text-[10px] font-semibold text-slate-700 hover:bg-slate-50">খালি ৪×৫</button>
                    <button type="button" wire:click="addCustomTableColumn({{ $blockIndex }})" class="rounded bg-slate-800 px-2 py-1 text-[10px] font-semibold text-white hover:bg-slate-900">+ টপ কলাম</button>
                    <button type="button" wire:click="addCustomTableRow({{ $blockIndex }})" class="rounded bg-slate-800 px-2 py-1 text-[10px] font-semibold text-white hover:bg-slate-900">+ সারি</button>
                </div>
