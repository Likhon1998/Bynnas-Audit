<div class="border-b border-slate-200 bg-slate-100 px-3 py-3 lg:px-5">
    <div class="mb-2 flex items-center justify-between gap-2">
        ...
        <span class="text-[13px] text-slate-500">পৃষ্ঠা ১৩ · Operational Audit</span>
    </div>
    ...
    <div class="mx-auto max-w-[1180px] rounded-sm bg-white p-6 shadow-lg">
        ...
        @include('livewire.partials.audit-page13-findings-section', [
            'editable' => true,
            'compact' => false,
        ...
        <div class="mt-6 flex items-center justify-between border-t border-dashed border-slate-200 pt-3">
            <p class="text-[13px] text-slate-500">পৃষ্ঠা ১৩</p>
