...
<div class="mt-2 flex flex-wrap items-center gap-1.5">
    ...
    @else
        <button
            ...
            class="inline-flex h-7 items-center rounded-md border border-slate-300 bg-white px-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-60"
        >
        ...
        <button
            ...
            wire:target="{{ $wireWithoutAi }},{{ $wireWithAi }}"
            @disabled(! $aiReady)
            class="inline-flex h-7 items-center rounded-md border border-violet-300 bg-violet-50 px-2 text-xs font-semibold text-violet-800 hover:bg-violet-100 disabled:cursor-not-allowed disabled:opacity-50"
