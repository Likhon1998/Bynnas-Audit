<div class="border-b border-slate-200 bg-slate-100 px-3 py-3 lg:px-5">
    ...
    @if (! empty($checklistUrl))
        <div class="mx-auto mb-3 max-w-[960px] rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-[12px] text-slate-700">
            ...
            <a href="{{ $checklistUrl }}" class="mt-1.5 inline-flex h-7 items-center rounded-md border border-teal-200 bg-white px-2.5 text-[13px] font-semibold text-teal-800 hover:bg-teal-50">Open checklist</a>
        </div>
    @endif
    <div class="mx-auto max-w-[960px] rounded-sm bg-white p-6 shadow-lg">
        ...
        <div class="mt-6 flex items-center justify-between border-t border-dashed border-slate-200 pt-3">
            <p class="text-[13px] text-slate-500">পৃষ্ঠা ৪ · + মেনু থেকে কমপ্লায়েন্স টেবিল যোগ করুন</p>
