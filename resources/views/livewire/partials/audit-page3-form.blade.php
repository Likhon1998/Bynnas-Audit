<div class="border-b border-slate-200 bg-slate-100 px-3 py-5 lg:px-6">
    <div class="mb-2 flex items-center justify-between gap-2">
        ...
        <span class="text-[13px] text-slate-500">সূচিপত্র এক নজরের সাথে · এখানে শ্রেণীবিন্যাস ও স্বাক্ষর</span>
    </div>
    ...
    <div class="mx-auto max-w-[960px] rounded-sm bg-white p-6 shadow-lg">
        ...
        <div class="mt-8 border-t border-dashed border-slate-200 pt-5">
            <p class="mb-3 text-[13px] font-semibold uppercase tracking-wide text-slate-500">প্রতিবেদনের শ্রেণীবিন্যাস (নির্দেশিকা)</p>
            @include('livewire.partials.audit-classification-table', ['compact' => false, 'editable' => true])
        </div>

        <div class="mt-8 border-t border-dashed border-slate-200 pt-5">
            <p class="mb-3 text-[13px] font-semibold uppercase tracking-wide text-slate-500">স্বাক্ষর অংশ (PDF পৃষ্ঠা ৩)</p>

            <div class="grid gap-4 md:grid-cols-3">
                <div class="rounded border border-slate-300 p-3">
                    <p class="mb-2 text-[12px] font-bold">নিরীক্ষা কর্মকর্তা</p>
                    <label class="mb-2 block text-[13px] text-slate-600">নাম
                        <input type="text" wire:model.live="sign_auditor_name" class="mt-1 inline-input w-full">
                    </label>
                    <label class="mb-2 block text-[13px] text-slate-600">পদবী
                        <input type="text" wire:model.live="sign_auditor_designation" class="mt-1 inline-input w-full">
                    </label>
                    <label class="block text-[13px] text-slate-600">তারিখ
        ...
        <div class="mt-6 flex items-center justify-between border-t border-dashed border-slate-200 pt-3">
            <p class="text-[13px] text-slate-500">পৃষ্ঠা ৩</p>
