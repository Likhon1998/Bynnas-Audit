...
<div class="overflow-hidden rounded-xl border border-slate-300 bg-white shadow-sm">
            ...
            <tbody>
                @foreach ($rows as $ri => $row)
                    <tr wire:key="f4-row-{{ $ri }}">
                        ...
                        <td class="border border-slate-300 p-0.5">
                            <input type="text" wire:model.live="payload.rows.{{ $ri }}.savings_amount" class="h-8 w-full border-0 bg-transparent px-1 text-[13px] focus:ring-1 focus:ring-[#2b579a]">
                        </td>
                        <td class="border border-slate-300 p-0.5">
                            <input type="text" wire:model.live="payload.rows.{{ $ri }}.loan_amount" class="h-8 w-full border-0 bg-transparent px-1 text-[13px] focus:ring-1 focus:ring-[#2b579a]">
                        </td>
    ...
    <div class="border-t border-slate-200 px-3 py-2.5">
        ...
        <p class="mb-2 text-xs text-slate-500">Unusual (✗) marks are emphasized for the audit report. Edit after AI writes.</p>
        <textarea
