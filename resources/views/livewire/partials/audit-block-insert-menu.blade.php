{{-- Compact insert control: opaque fixed dropdown (above all sibling + buttons) --}}
@php
...
>
    ...
    <button
        ...
        class="relative flex h-5 w-5 items-center justify-center rounded-full border border-slate-300 bg-white text-[14px] leading-none text-slate-500 shadow-sm opacity-55 transition hover:border-emerald-500 hover:bg-emerald-50 hover:text-emerald-700 hover:opacity-100 group-hover:opacity-100 {{ $end ? 'opacity-80' : '' }}"
    ...
    <template x-teleport="body">
        <div x-show="open" x-cloak style="display: none;">
            {{-- Blocks clicks to + buttons / tables underneath --}}
            <div
                class="fixed inset-0"
            ...
            >
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'finding')"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'section')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'criteria')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'observation')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'stats')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'custom_table')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'followup_pack')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'risk')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'root_cause')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'recommendation')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'jobab_table')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
                ...
                <button
                    type="button"
                    @click="close(); $wire.insertBlockAt({{ $insertIndex }}, 'text_box')"
                    class="mx-1 mb-0.5 flex w-[calc(100%-0.5rem)] items-center gap-2 rounded-md px-2.5 py-2 text-left text-[11px] font-semibold"
