...
<table class="<?php echo e($compact ? 'a4-table a4-table-compact text-[8px]' : 'w-full border-collapse text-[9px]'); ?> min-w-full">
                <thead>
                    <tr class="bg-slate-100">
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" rowspan="2">সমিতি নং</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" rowspan="2">সদস্যের নাম ও আইডি</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" colspan="2">১ম দফা ঋণের আংশিক সমন্বয়</th>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editable): ?>
                    ...
                    <tr class="bg-slate-100">
                        ...
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">টাকা</th>
                    </tr>
                </thead>
                <tbody>
