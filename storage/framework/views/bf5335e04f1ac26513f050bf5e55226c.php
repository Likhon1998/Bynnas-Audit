...
<table class="<?php echo e($tableClass); ?> mb-[2mm]">
        <thead>
            <tr class="bg-slate-100">
                <th class="<?php echo e($cellPad); ?> font-semibold">তারিখ</th>
                <th class="<?php echo e($cellPad); ?> font-semibold">ভাউচারের ধরন ও নং</th>
                <th class="<?php echo e($cellPad); ?> font-semibold">খরচের বিবরণ</th>
                <th class="<?php echo e($cellPad); ?> font-semibold">টাকার পরিমাণ</th>
                <th class="<?php echo e($cellPad); ?> font-semibold">মন্তব্য</th>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editable): ?>
