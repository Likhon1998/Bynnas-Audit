...
<?php $component->withAttributes([]); ?>
    <div class="px-4 py-5 lg:px-6">
        <div class="mb-4 flex flex-wrap items-start justify-between gap-2.5">
            ...
            <a href="<?php echo e(route('annual-audit.index', ['tab' => 'project_audit'])); ?>" class="rounded-lg border border-slate-200 bg-white px-2.5 py-1.5 text-[12px] font-medium text-slate-700 hover:bg-slate-50">
                Open Annual Audit
            </a>
        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $project->locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="text-[12px]">
                                    <td class="px-4 py-2.5 font-medium text-navy-900"><?php echo e($location->name); ?></td>
                                    <td class="px-4 py-2.5 text-slate-600"><?php echo e($location->division ?: '—'); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'name','name' => 'name','type' => 'text','class' => 'block w-full rounded-lg text-[13px]','value' => old('name'),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name','name' => 'name','type' => 'text','class' => 'block w-full rounded-lg text-[13px]','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name')),'required' => true]); ?>
