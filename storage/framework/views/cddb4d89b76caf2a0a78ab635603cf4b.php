<div class="border-b border-slate-200 bg-slate-100 px-3 py-5 lg:px-6">
    ...
    <div class="mx-auto max-w-[1180px] rounded-sm bg-white p-6 shadow-lg">
        <?php echo $__env->make('livewire.partials.audit-page16-findings-section', [
            'editable' => true,
            'compact' => false,
...
<?php /**PATH C:\xampp\htdocs\Bynnas-Audit\resources\views\livewire\partials\audit-page16-form.blade.php ENDPATH**/ ?>