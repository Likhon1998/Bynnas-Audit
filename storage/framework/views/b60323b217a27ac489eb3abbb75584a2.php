...
<?php endif; ?>
    ...
    <p class="border-t border-slate-100 px-4 py-2 text-[11px] text-slate-500">
        Green cells = planned <?php echo e($isAudit ? 'audit' : 'monitoring'); ?> visit (like Excel). Click to add/remove. Use <span class="font-medium text-slate-700">Remove</span> / <span class="font-medium text-slate-700">Delete</span> to undo mistakes.
    </p>
</div>
