...
<?php $component->withAttributes([]); ?>
    <div class="px-4 py-5 lg:px-6">
        ...
        <div class="max-w-lg overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-card">
            ...
            <form method="POST" action="<?php echo e(route('areas.store')); ?>" class="px-4 py-4">
                <?php echo csrf_field(); ?>
                <div class="space-y-3">
                    <div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'name','name' => 'name','type' => 'text','class' => 'block w-full rounded-lg text-[13px]','value' => old('name'),'required' => true,'placeholder' => 'e.g. Dhaka North']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name','name' => 'name','type' => 'text','class' => 'block w-full rounded-lg text-[13px]','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name')),'required' => true,'placeholder' => 'e.g. Dhaka North']); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <select id="division" name="division" required class="block w-full rounded-lg border-slate-200 text-[13px] text-slate-800 shadow-sm focus:border-brand-500 focus:ring-brand-500">
                            <option value="" disabled <?php if(! old('division')): echo 'selected'; endif; ?>>Select division</option>
...
<?php endif; ?>
                ...
                <div class="mt-4 flex items-center justify-end gap-2 border-t border-slate-100 pt-3.5">
                    <a href="<?php echo e(route('areas.index')); ?>" class="rounded-lg px-3 py-1.5 text-[12px] font-medium text-slate-500 hover:bg-slate-50">Cancel</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Bynnas-Audit\resources\views/areas/create.blade.php ENDPATH**/ ?>