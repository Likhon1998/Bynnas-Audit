    ...
    <body class="font-sans antialiased text-slate-800" x-data="{ sidebarOpen: false, searchOpen: false }" @keydown.window.prevent.ctrl.k="searchOpen = true" @keydown.window.escape="searchOpen = false; sidebarOpen = false">
        ...
        >
            <div class="w-full max-w-xl overflow-hidden rounded-2xl bg-white shadow-2xl" @click.stop>
                ...
                <div class="p-2">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-slate-600 hover:bg-slate-50">Dashboard</a>
                    <a href="<?php echo e(route('organogram')); ?>" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-slate-600 hover:bg-slate-50">Organogram</a>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-slate-600 hover:bg-slate-50">Settings</a>
                </div>
            </div>
        </div>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\bynnas_Audit\resources\views\layouts\app.blade.php ENDPATH**/ ?>