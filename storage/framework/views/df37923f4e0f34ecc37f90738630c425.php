...
>
    <div class="relative z-10 flex items-center gap-2 px-2.5 pb-1.5 pt-3.5" :class="sidebarCollapsed && 'lg:flex-col lg:gap-2 lg:px-1.5'">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-lg" title="Bynnas Audit">
            <img src="<?php echo e(asset('images/bynnas-logo.png')); ?>" alt="Bynnas" class="h-9 w-9 object-contain">
        </a>
...
<?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['shakhas.manage', 'shakhas.view_all', 'areas.manage'])): ?>
                <div x-data="{ shakhaOpen: <?php echo e(request()->routeIs('shakhas.*') || request()->routeIs('areas.*') ? 'true' : 'false'); ?> }">
                    ...
                    >
                        <svg class="h-3.5 w-3.5 shrink-0 <?php echo e(request()->routeIs('shakhas.*') || request()->routeIs('areas.*') ? 'text-white' : 'text-slate-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <nav class="space-y-0.5">
            <?php if (isset($component)) { $__componentOriginal3d3185cbc95d2b4d3b41182ae7d7a300 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3d3185cbc95d2b4d3b41182ae7d7a300 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sidebar-link','data' => ['href' => route('profile.edit'),'active' => request()->routeIs('profile.*'),'title' => 'Settings']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('sidebar-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('profile.*')),'title' => 'Settings']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
