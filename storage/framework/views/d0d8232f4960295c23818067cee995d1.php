    ...
    >
                ...
                <table class="w-full border-collapse text-[8px] leading-tight" style="table-layout: fixed;">
                    ...
                    <tbody>
                        <?php
                            ...
                            $n = count($sampleRows);
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sampleRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i === 0): ?>
                                    <td class="relative border border-rose-500 bg-rose-50 px-0.5 py-0.5 text-center align-middle font-semibold" rowspan="<?php echo e($n); ?>">
                                        <span class="absolute left-0.5 top-0.5 rounded bg-rose-600 px-0.5 text-[7px] font-bold text-white">B</span>
                                        জুলাই–জুন<br><span class="text-[7px] font-normal text-rose-800">↓ মার্জ <?php echo e($n); ?> সারি</span>
                                    </td>
                                    <td class="relative border border-rose-500 bg-rose-50 px-0.5 py-0.5 text-center align-middle font-semibold" rowspan="<?php echo e($n); ?>">
                                        <span class="absolute left-0.5 top-0.5 rounded bg-rose-600 px-0.5 text-[7px] font-bold text-white">B</span>
                                        সংশ্লিষ্ট সকল
                                ...
                                <td class="border border-slate-600 px-1 py-0.5 text-left"><?php echo e($desc); ?></td>
        ...
        <div class="flex flex-wrap items-center gap-2 border-t border-sky-100 bg-white px-3 py-2.5">
            <button
                ...
                @click="open = false; $wire.applyCustomTableTemplate(<?php echo e($bi); ?>, 'expense')"
...
<?php /**PATH C:\xampp\htdocs\Bynnas-Audit\resources\views/livewire/partials/audit-custom-table-example-popover.blade.php ENDPATH**/ ?>