...
<table class="<?php echo e($tableClass); ?> min-w-full">
                <thead>
                    <tr class="bg-slate-100">
                        ...
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" rowspan="2">সদস্যের নাম/আইডি</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" rowspan="2">তারিখ</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" colspan="5">পাসবই অনুযায়ী আদায়ের তথ্য</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" colspan="2">জমার তথ্য</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" rowspan="2">পার্থক্য</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center" rowspan="2">কর্মীর নাম ও আইডি</th>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editable): ?>
                            <th class="<?php echo e($cellPad); ?>" rowspan="2"></th>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tr>
                    <tr class="bg-slate-50">
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">বা: স:</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">স্বেচ্ছা</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">মেয়াদী</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">কিস্তি</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">মোট আদায়</th>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ($finding['samityRows'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIndex => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editable): ?>
                                <td class="<?php echo e($cellPad); ?> text-center">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($finding['samityRows'] ?? []) > 1): ?>
