...
<?php
    ...
    $rowCount = (int) ($definition['default_rows'] ?? 3);
?>
        ...
        <table class="min-w-[1100px] w-full border-collapse text-[11px]">
            <thead>
                <tr class="bg-slate-100 text-center font-semibold text-slate-700">
                    ...
                    <th class="border border-slate-300 px-1 py-1.5">সঞ্চয় আদায় টাকা</th>
                    <th class="border border-slate-300 px-1 py-1.5">ঋণ আদায় টাকা</th>
...
<?php /**PATH C:\xampp\htdocs\Bynnas-Audit\resources\views\livewire\partials\audit-checklist-format-4-preview.blade.php ENDPATH**/ ?>