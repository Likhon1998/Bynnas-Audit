...
<table class="<?php echo e($compact ? 'a4-table a4-table-compact text-[8px]' : 'w-full border-collapse text-[9px]'); ?> min-w-full">
                <thead>
                    <tr class="bg-slate-100">
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">কর্মীর নাম</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">সমিতি নং</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">মোট সদস্য</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">প্রাপ্ত পাসবই সংখ্যা</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">অনুপস্থিত পাসবই সংখ্যা</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold text-center">নিরীক্ষা/ পরিবীক্ষণ কর্মকর্তার মন্তব্য</th>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editable): ?>
