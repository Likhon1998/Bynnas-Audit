...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div
        ...
        x-data="{
            name: <?php echo \Illuminate\Support\Js::from((string) old('name', $shakha?->name ?? ''))->toHtml() ?>,
            code: <?php echo \Illuminate\Support\Js::from((string) old('code', $shakha?->code ?? ''))->toHtml() ?>,
            status: <?php echo \Illuminate\Support\Js::from((string) old('status', $shakha?->status ?? 'active'))->toHtml() ?>,
            areaId: <?php echo \Illuminate\Support\Js::from(old('area_id') !== null ? (string) old('area_id') : (string) ($shakha?->area_id ?? ''))->toHtml() ?>,
    ...
    >
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div class="flex items-center gap-1.5 text-[11px] text-slate-400">
                ...
                <span>/</span>
                <span class="text-slate-600"><?php echo e($isEdit ? 'Edit Shakha' : 'Add Shakha'); ?></span>
            </div>
        ...
        <form
            method="POST"
            action="<?php echo e($isEdit ? route('shakhas.update', $shakha) : route('shakhas.store')); ?>"
            ...
            <div class="rounded-2xl border border-slate-100 bg-white shadow-card">
                <div class="border-b border-slate-100 px-5 py-3.5">
                    ...
                    <p class="mt-0.5 text-[11px] text-slate-500">
                        <?php echo e($isEdit ? 'Update the branch record below.' : 'Complete the fields below to create a branch record.'); ?>

                    </p>
                </div>

                <div class="space-y-5 px-5 py-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($areas->isEmpty()): ?>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input
                                    ...
                                    name="name"
                                    type="text"
                                    value="<?php echo e(old('name', $shakha?->name)); ?>"
                                    x-model="name"
                                    required
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="code"
                                    type="text"
                                    value="<?php echo e(old('code', $shakha?->code)); ?>"
                                    x-model="code"
                                    <?php if($areas->isEmpty()): echo 'disabled'; endif; ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="opening_date"
                                    type="date"
                                    value="<?php echo e($openingDefault); ?>"
                                    required
                                    <?php if($areas->isEmpty()): echo 'disabled'; endif; ?>
                                    class="block w-full rounded-lg border-slate-200 text-[13px] text-slate-800 shadow-sm focus:border-brand-500 focus:ring-brand-500 disabled:cursor-not-allowed disabled:bg-slate-50"
                                >
                                ...
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('opening_date'),'class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('opening_date')),'class' => 'mt-1']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    value="<?php echo e(old('focal_person_name', $shakha?->focal_person_name)); ?>"
                                    <?php if($areas->isEmpty()): echo 'disabled'; endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('focal_person_name'),'class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('focal_person_name')),'class' => 'mt-1']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                    ...
                    <section class="border-t border-slate-100 pt-5">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $areasByDivision; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division => $divisionAreas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <optgroup label="<?php echo e($division); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $divisionAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <option value="<?php echo e($area->id); ?>" <?php if((string) old('area_id', $shakha?->area_id) === (string) $area->id): echo 'selected'; endif; ?>>
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 border-t border-slate-100 bg-slate-50/70 px-5 py-3.5">
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        >
                            ...
                            <?php echo e($isEdit ? 'Update Shakha' : 'Save Shakha'); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Bynnas-Audit\resources\views\shakhas\form.blade.php ENDPATH**/ ?>