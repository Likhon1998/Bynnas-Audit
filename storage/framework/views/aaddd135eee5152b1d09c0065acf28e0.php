...
<?php if($compact): ?>
    ...
    <?php echo e($p); ?>.doc-financial {
        ...
        min-height: 0;
        height: auto;
        font-size: <?php echo e($compact ? '10pt' : '11pt'); ?>;
        line-height: <?php echo e($compact ? '1.4' : '1.45'); ?>;
        color: #111;
    }
...
<?php endif; ?>
    ...
    <?php echo e($p); ?>h2 {
        text-align: center;
        font-size: <?php echo e($compact ? '12pt' : '14pt'); ?>;
        font-weight: 700;
        text-decoration: underline;
        margin: <?php echo e($compact ? '2.5mm 0 2.5mm' : '5mm 0 4mm'); ?>;
    }
    <?php echo e($p); ?>h3 {
        text-align: center;
        font-size: <?php echo e($compact ? '11pt' : '12.5pt'); ?>;
        font-weight: 700;
        text-decoration: underline;
        margin: <?php echo e($compact ? '2.5mm 0 2mm' : '4mm 0 2.5mm'); ?>;
    }
    ...
    <?php echo e($p); ?>table.toc-table tbody td.center {
        font-size: 8pt;
        word-wrap: break-word;
        overflow-wrap: anywhere;
    }
    ...
    <?php echo e($p); ?>.org-name { font-size: <?php echo e($compact ? '14pt' : '18pt'); ?>; font-weight: 700; margin: 0; line-height: 1.1; }
    <?php echo e($p); ?>.org-bn { font-size: <?php echo e($compact ? '10.5pt' : '11.5pt'); ?>; font-weight: 700; margin: 0; }
    <?php echo e($p); ?>.org-en {
        font-size: 8pt;
        font-weight: 700;
    ...
    <?php echo e($p); ?>.header-table td.logo-cell { width: 68%; padding-right: 3mm; }
    <?php echo e($p); ?>.header-table td.rating-wrap {
        width: 32%;
        max-width: 38mm;
        text-align: right;
        vertical-align: top;
    ...
    <?php echo e($p); ?>.it-tick,
    <?php echo e($p); ?>span.it-tick {
    ...
    <?php echo e($p); ?>table.it-checklist-table th {
        font-size: 9pt;
        background: #e2e8f0;
        padding: 2.2mm 1.5mm;
    }
    <?php echo e($p); ?>table.it-checklist-table td {
        font-size: 9.5pt;
        padding: 2mm 1.6mm;
        line-height: 1.4;
    }
    <?php echo e($p); ?>table.it-checklist-table .it-tick-cell {
        text-align: center;
        vertical-align: middle;
        font-size: 12pt;
    }
    <?php echo e($p); ?>table.external-audit-table th {
        font-size: 9pt;
        background: #f0e4d4;
        padding: 2.2mm 1.5mm;
    }
    <?php echo e($p); ?>table.external-audit-table td {
        font-size: 9.5pt;
        padding: 2mm 1.6mm;
        line-height: 1.4;
    }
