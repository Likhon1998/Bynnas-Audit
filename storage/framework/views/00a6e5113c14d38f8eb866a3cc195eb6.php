    ...
    >
        ...
        <div class="mb-3 flex flex-wrap items-start justify-between gap-3">
            ...
            <div class="ml-auto flex flex-wrap items-center justify-end gap-1.5">
                ...
                <a
                    ...
                    title="Download <?php echo e($monthLabel); ?> <?php echo e($year); ?> — indicators × shakhas matrix"
                >
                    ...
                    Download <?php echo e($monthLabel); ?> <?php echo e($year); ?>
        ...
        <div class="mb-3 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 px-3 py-2">
                <p class="text-[12px] font-semibold text-navy-900"><?php echo e($year); ?> — pick a month</p>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $monthStrip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a
                        ...
                        class="rounded-md px-1.5 py-1.5 text-center transition
                            <?php echo e($chip['active']
                                ? 'bg-navy-900 text-white shadow-sm'
                                : ($chip['has_data'] ? 'bg-sky-50 text-sky-900 hover:bg-sky-100' : 'bg-slate-50 text-slate-500 hover:bg-slate-100')); ?>"
                        title="<?php echo e($chip['full']); ?><?php echo e($chip['has_data'] ? ' · '.$chip['cells'].' cells · '.$chip['branches'].' branches' : ''); ?>"
                    >
                        <span class="block text-[11px] font-semibold"><?php echo e($chip['label']); ?></span>
                        <span class="mt-0.5 block text-[9px] tabular-nums <?php echo e($chip['active'] ? 'text-slate-300' : 'text-slate-400'); ?>">
                            <?php echo e($chip['has_data'] ? $chip['cells'] : '—'); ?>
        ...
        <div id="findings-matrix-table" class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-100 px-3 py-2">
                <p class="text-[12px] font-semibold text-navy-900"><?php echo e(date('F', mktime(0, 0, 0, $month, 1))); ?> <?php echo e($year); ?> — organization totals</p>
