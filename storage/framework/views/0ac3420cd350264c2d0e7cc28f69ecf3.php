...
<table class="<?php echo e($tableClass); ?> min-w-full">
                <thead>
                    <tr class="bg-slate-100">
                        ...
                        <th class="<?php echo e($cellPad); ?> font-semibold">ক্রয়ের তারিখ ও ভাউচার নং</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold">ক্রয়কৃত পণ্যের মূল্য</th>
                        <th class="<?php echo e($cellPad); ?> font-semibold">স্টক রেজিস্টারের অবস্থা</th>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editable): ?>
