    ...
    <div class="px-4 py-5 lg:px-6">
        <div class="mb-3 flex flex-nowrap items-center gap-2 overflow-x-auto pb-0.5">
            ...
            <label class="inline-flex shrink-0 items-center gap-1 text-[11px] text-slate-400">
                ...
                >
                    <?php $__currentLoopData = $availablePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $availablePlan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
        ...
        <div class="mb-3 flex flex-wrap gap-1.5">
            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tabMeta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a
