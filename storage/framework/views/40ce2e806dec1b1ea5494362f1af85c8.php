...
<table class="doc-table compact glance-table">
    ...
    <tbody>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $glanceRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <tr>
                <td class="left-align"><?php echo e($row['left_label'] !== '' ? $row['left_label'] : '—'); ?></td>
                <td class="center bold">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['left_value'] !== ''): ?>
                        <?php echo \App\Support\BanglaNumerals::highlight($row['left_value'], 'stat'); ?>
                ...
                <td class="left-align"><?php echo e($row['right_label'] !== '' ? $row['right_label'] : '—'); ?></td>
                <td class="center bold">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['right_value'] !== ''): ?>
                        <?php echo \App\Support\BanglaNumerals::highlight($row['right_value'], 'stat'); ?>
...
<?php /**PATH C:\xampp\htdocs\Bynnas-Audit\resources\views/audits/partials/glance-table.blade.php ENDPATH**/ ?>